...
cmo.setListenAddress('192.168.0.53')
...
cmo.setListenAddress('192.168.0.54')
...
set('Targets',jarray.array([ObjectName('com.bea:Name=ManagedServer3,Type=Server'), ObjectName('com.bea:Name=ManagedServer4,Type=Server')], ObjectName))
...
cd('/MigratableTargets/ManagedServer3 (migratable)')
...
cd('/MigratableTargets/ManagedServer4 (migratable)')
set('ConstrainedCandidateServers',jarray.array([], ObjectName))
...
cmo.setDirectory('/export/common/general/txtest/antserver/txtest-srvmig/tlog')
